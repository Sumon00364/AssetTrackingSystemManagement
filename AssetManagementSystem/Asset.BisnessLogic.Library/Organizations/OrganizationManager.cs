...
namespace Asset.BisnessLogic.Library.Organizations
{
    public class OrganizationManager : IRepositoryManager<Organization>
    {
        ...
        public bool IsOrganizationNameExist(string name)
        {
            bool isNameExist = false;
            var organizationName = GetOrganizationByOrganizationName(name);
        ...
        private Organization GetOrganizationByOrganizationName(string name)
        {
            return _organizationGetway.GetOrganizationByOrganizationName(name);
        }
        ...
        private Organization GetOrganizationByShortName(string shortName)
        {
